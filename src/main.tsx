...
// Enregistrement du service worker uniquement en production (évite les conflits Vite en dev)
if ('serviceWorker' in navigator && import.meta.env.PROD) {
  window.addEventListener('load', () => {
    navigator.serviceWorker
      .register('/service-worker.js')
      .then((registration) => {
        // Vérifie immédiatement s'il existe une mise à jour du SW
        try { registration.update(); } catch {}

        // Recharge automatiquement une seule fois lorsque le nouveau SW prend le contrôle
        let refreshed = false;
