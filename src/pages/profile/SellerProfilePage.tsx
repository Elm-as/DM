...
const SellerProfilePage: React.FC = () => {
  ...
  const [seller, setSeller] = useState<{ id: string; full_name: string; created_at: string } | null>(null);
  const [listings, setListings] = useState<Array<{ id: string; title: string; photos?: string[] | null; price?: number; status?: string }>>([]);
