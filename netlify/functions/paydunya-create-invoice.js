...
exports.handler = async (event) => {
  ...
  try {
    ...
    const invoiceData = {
      ...
      actions: {
        return_url: `https://daloamarket.shop/payment/success?type=${type}&user_id=${userId}${annonceId ? `&listing_id=${annonceId}` : ''}`,
        cancel_url: `https://daloamarket.shop/payment/failure?type=${type}`,
        callback_url: `https://daloamarket.shop/.netlify/functions/paydunya-callback`
      },
      custom_data: {
        user_id: userId,
        type: type,
